...
'</td>'
'<td style="padding:9px 8px;text-align:right;font-family:monospace;font-size:14px;font-+ str(round(p["adp"], 1)) +
'</td>'
'<td style="padding:9px 8px;text-align:right;font-family:monospace;font-size:13px;font-+ ar + ' ' + str(abs(p["delta"])) +
'</td>'
'</tr>'
)
def table(rows_html):
...
continue
pc = POS_COLORS[pos]
body += '<div style="font-size:12px;font-weight:700;color:' + pc + ';margin:14px 0 4px">' if pr:
...
'<body style="margin:0;padding:0;background:#0f0d0b;font-family:Helvetica Neue,Arial,'<div style="max-width:520px;margin:0 auto;padding:24px 16px">'
